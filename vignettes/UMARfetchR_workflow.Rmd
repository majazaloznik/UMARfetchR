...
The `umar-add_new_series_metadata.R` in the `O:/Avtomatizacija/umar-automation-scripts` repository is the script you want, and you run it manually when an author informs you they have metadata ready for ingestion.
